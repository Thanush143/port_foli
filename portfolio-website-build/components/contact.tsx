      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-3 mb-4">
            ...
            <p className="text-indigo-400 uppercase text-xs sm:text-sm font-semibold tracking-widest">Contact</p>
          ...
          <p className="text-gray-300 text-lg">Have a project in mind? Let&apos;s talk.</p>
        </motion.div>
